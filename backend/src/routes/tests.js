...
// Serve files by ID (new database-backed approach)
router.get('/files/:fileId', async (req, res) => {
  try {
    ...
    if (file.content && (file.file_type === 'json' || file.file_type === 'text')) {
      res.setHeader('Content-Type', file.file_type === 'json' ? 'application/json' : 'text/plain')
